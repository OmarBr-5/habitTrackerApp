...
def create_4_week_test_data() -> Tuple[List[Habit], List[Completion]]:
    ...
    for week in range(4):
            ...
            if week < 2:  # Complete all days in first 2 weeks
                completions.append(
                    Completion(
                        ...
                        habit_id=1,
                        date_of_completion=datetime.datetime.combine(
                            current_date, datetime.time(8, 0, 0)
                        ),
                    )
                )
            ...
            if day != 4:  # Skip Friday (index 4)
                completions.append(
                    Completion(
                        ...
                        habit_id=2,
                        date_of_completion=datetime.datetime.combine(
                            current_date, datetime.time(19, 0, 0)
                        ),
                    )
                )
            ...
            if day in [0, 1, 2, 5, 6]:  # Mon, Tue, Wed, Sat, Sun
                completions.append(
                    Completion(
                        ...
                        habit_id=3,
                        date_of_completion=datetime.datetime.combine(
                            current_date, datetime.time(7, 0, 0)
                        ),
                    )
                )
        ...
        completions.append(
            Completion(
                ...
                habit_id=4,
                date_of_completion=datetime.datetime.combine(
                    sunday_date, datetime.time(18, 0, 0)
                ),
            )
        )
        ...
        completions.append(
            Completion(
                ...
                habit_id=5,
                date_of_completion=datetime.datetime.combine(
                    wednesday_date, datetime.time(17, 0, 0)
                ),
            )
        )
    ...
    completions.insert(
        ...
        Completion(
            ...
            habit_id=1,
            date_of_completion=datetime.datetime.combine(
                prev_week_date, datetime.time(8, 0, 0)
            ),
        ),
    )
    ...
    completions.append(
        Completion(
            ...
            habit_id=2,
            date_of_completion=datetime.datetime.combine(
                next_week_date, datetime.time(19, 0, 0)
            ),
        )
    )
